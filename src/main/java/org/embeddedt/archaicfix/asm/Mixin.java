...
public enum Mixin implements IMixin {
    // COMMON MIXINS
    common_chickenchunks_MixinPlayerChunkViewerManager(Side.COMMON, always(), "chickenchunks.MixinPlayerChunkViewerManager"),
    ...
    common_core_MixinEntityItem(Side.COMMON, always(), "core.MixinEntityItem"),
    ...
    common_gt6_MixinAdvancedCraftingXToY(Side.COMMON, always(), "gt6.MixinAdvancedCraftingXToY"),
    common_gt6_MixinGT6_Main(Side.COMMON, always(), "gt6.MixinGT6_Main"),
    common_gt6_MixinCR(Side.COMMON, always(), "gt6.MixinCR"),
    ...
    common_mo_MixinMatterRegistry(Side.COMMON, always(), "mo.MixinMatterRegistry"),
    common_mo_MixinMatterRegistrationHandler(Side.COMMON, always(), "mo.MixinMatterRegistrationHandler"),
    common_mo_MixinVersionCheckHandler(Side.COMMON, always(), "mo.MixinVersionCheckHandler"),
    common_mrtjp_MixinBlockUpdateHandler(Side.COMMON, always(), "mrtjp.MixinBlockUpdateHandler"),
    common_pregen_MixinChunkProcessor(Side.COMMON, always(), "pregen.MixinChunkProcessor"),
    common_pregen_MixinChunkHelper(Side.COMMON, always(), "pregen.MixinChunkHelper"),
    common_projecte_MixinRecipeShapelessHidden(Side.COMMON, always(), "projecte.MixinRecipeShapelessHidden"),
    common_tc4tweaks_MixinGenerateItemHash(Side.COMMON, always(), "tc4tweaks.MixinGenerateItemHash"),
    common_tc4tweaks_MixinMappingThread(Side.COMMON, always(), "tc4tweaks.MixinMappingThread"),
    common_thermal_MixinTECraftingHandler(Side.COMMON, always(), "thermal.MixinTECraftingHandler"),
    // CLIENT MIXINS
    ...
    client_gt6_MixinGT_API_Proxy_Client(Side.CLIENT, always(), "gt6.MixinGT_API_Proxy_Client"),
