...
public enum Mixin implements IMixin {
    ...
    common_core_MixinNetworkDispatcher(Side.COMMON, always(), "core.MixinNetworkDispatcher"),
    ...
    client_core_MixinNetHandlerLoginClient(Side.CLIENT, always(), "core.MixinNetHandlerLoginClient"),
